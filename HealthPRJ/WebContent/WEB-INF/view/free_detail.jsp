			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				<form class="login100-form validate-form flex-sb flex-w">
					...
					<div class="wrap-input100 validate-input m-b-20" data-validate = "제목을 입력해주세요.">
						<input class="input100" type="text" name="title" style="background-color:white; width:1000px" placeholder="제목">
						<span class="focus-input100"></span>
					</div>
					
					
					<div class="wrap-input100 validate-input m-b-20" data-validate = "내용을 입력해주세요.">
						<textarea class="input100" name="content" style="background-color:white; width:1000px; height:500px" placeholder="내용"></textarea>
						<span class="focus-input100"></span>
					</div>
